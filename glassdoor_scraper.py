    ...
    while current_page <= num_pages:   
        ...
        while not done:
            ...
            for card in job_cards:
                ...
                try:
                    if driver.find_elements("xpath","//div[@class='css-t3xrds e856ufb4']"):
                ...
                try:
                    ...
                    # WILL HAVE TO CHECK SALARY ESTIMATE ELEMENT IN job cards
                ...
                rec_count+=1
                print(f'{rec_count} records updated')                        
                done = True
       ...
       # Moves to the next page         
        if done:
            ...
            try:
                if driver.find_element("xpath","//span[@alt='next-icon']"):
...
fetch_jobs("Data Science","India",30)
